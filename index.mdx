...
<CardGroup cols={2}>
  <Card
    title="Suna - Flagship AI Worker"
    icon="robot"
    href="/suna/overview"
  >
    Meet Suna, our showcase agent that demonstrates the full power of the Utari platform through natural conversation.
  </Card>
  <Card
  ...
  <Card
    ...
    icon="globe"
    href="/capabilities/browser-automation"
  >
